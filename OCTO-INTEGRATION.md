...
更新：2026-09-15。配置后端、原生管理页面与官方元数据接入已部署；尚未切换 Bot 查询链路。数据源实现与剩余设计边界分别说明，进度以 [OCTO-STATUS](OCTO-STATUS.md) 为准。
...
当前来源使用与只读 API 的准确契约见 [来源配置指南](OCTO-SOURCES.md)。以下为设计基线，完成状态以进度为准。
