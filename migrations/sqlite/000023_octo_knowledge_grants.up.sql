...
ALTER TABLE octo_scopes ADD COLUMN allow_knowledge_creation BOOLEAN NOT NULL DEFAULT 0;
ALTER TABLE octo_scopes ADD COLUMN aggregate_child_issues BOOLEAN NOT NULL DEFAULT 0;
