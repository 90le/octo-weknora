...
export default {
  ...
  localBrowser: {
    ...
    "scrollPage": "페이지 스크롤",
    "focusElement": "요소에 초점 맞추기",
    "blurElement": "초점 해제",
    "selectOption": "옵션 선택",
    "closeTab": "탭 닫기",
    "runScript": "페이지 스크립트 실행",
    "readConsole": "콘솔 확인",
    "readNetwork": "네트워크 요청 확인",
    "resizeWindow": "창 크기 조정",
    "emulateDevice": "기기 에뮬레이션",
    "actionPending": "브라우저 조작 중…",
    "actionRecorded": "브라우저 작업 기록됨",
    "untitledTab": "제목 없는 탭",
    "contentTruncated": "페이지 내용의 일부만 표시됩니다.",
    "controlScope": "이 대화의 브라우저 작업만 제어",
    "pauseHint": "브라우저 작업을 중단하고 재개할 수 있도록 페이지를 유지합니다. 대화는 중단하지 않습니다.",
    "stopHint": "이 작업에서 만든 탭을 닫고 빌린 탭을 반환합니다. 브라우저와 페어링은 유지합니다.",
    "openPage": "페이지 열기",
    "switchPage": "페이지 전환",
    "readPage": "페이지 확인",
    "listTabs": "탭 목록",
    ...
    "openTab": "작업 탭 만들기",
    "switchTab": "작업 탭 전환",
    "authorizeTab": "탭 권한 요청",
    "returnTab": "탭 반환",
    "needHelp": "사용자 입력 필요",
    "browserAction": "브라우저 작업",
    "actionFailed": "미완료",
    "actionCompleted": "작업 완료",
    "commandBusy": "이전 작업이 실행 중입니다. 완료될 때까지 기다려 주세요.",
    "invalidArguments": "브라우저 도구 인수가 잘못되었거나 불완전합니다. 에이전트가 수정해야 합니다.",
    "commandInterrupted": "작업이 중단되었습니다. 페이지를 확인한 뒤 미리보기에서 재개하세요.",
    "actionFailedHint": "브라우저 작업이 완료되지 않았습니다. 페이지를 확인하고 다시 시도하세요.",
    "previewStale": "화면이 갱신되지 않음",
    ...
    "pairingReady": "복사되었습니다. 5분 안에 확장 프로그램에 붙여넣으세요. 한 번만 사용할 수 있습니다.",
    "copyAgain": "다시 복사",
    "usageTitle": "사용 방법",
  ...
  settings: {
    ...
    skills: {
      ...
      addStepRegister: '등록',
      addStepInstall: '설치',
      addStepRegisterDesc: '소스를 붙여넣거나 zip을 업로드해 먼저 워크스페이스 카탈로그에 등록합니다.',
      addStepInstallDesc: '파싱된 스킬을 확인한 뒤 설치할 샌드박스를 선택하세요. 건너뛰고 나중에 목록에서 설치할 수도 있습니다.',
      addFinish: '완료',
      ...
      installToSandbox: '샌드박스에 설치',
      installToSandboxDesc: '각 샌드박스 백엔드는 따로 설치해야 합니다. Docker, Cube, E2B 이미지는 호환되지 않습니다.',
      pickSandboxes: '설치할 샌드박스',
      pickSandboxesHint: '스킬은 선택한 샌드박스가 사용하는 이미지에 기록됩니다. Docker, Cube, E2B 이미지는 호환되지 않으므로 샌드박스마다 따로 설치합니다. 지금 건너뛰고 나중에 카탈로그에서 설치할 수 있습니다.',
