...
const toolDisplayNameKeys: Record<string, string> = {
    ...
    source_browse: 'datasource.source.browse',
    github_release_lookup: 'agentEditor.tools.githubReleaseLookup',
    octo_knowledge_operations: 'agentEditor.tools.octoKnowledgeOperations',
